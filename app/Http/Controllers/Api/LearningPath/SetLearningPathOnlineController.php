...
class SetLearningPathOnlineController extends Controller
{
    /**
    ...
    {
        try{
            LearningPathRepository::setLearningPathOnline($learning_path_id);
            return $this->returnSuccessResponse(__('learning_path_set_online'), null, ResponseAlias::HTTP_OK);
