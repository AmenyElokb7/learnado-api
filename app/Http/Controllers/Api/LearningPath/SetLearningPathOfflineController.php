...
class SetLearningPathOfflineController extends Controller
{
    /**
    ...
    public function __invoke($learning_path_id): JsonResponse
    {
        try
        {
            LearningPathRepository::setLearningPathOffline($learning_path_id);
            return $this->returnSuccessResponse(__('learning_path_set_offline'), null, ResponseAlias::HTTP_OK);
