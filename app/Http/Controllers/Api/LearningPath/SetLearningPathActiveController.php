...
class SetLearningPathActiveController extends Controller
{
    /**
    ...
    {
        try{
            LearningPathRepository::setLearningPathActive($learning_path_id);
            return $this->returnSuccessResponse(__('learning_path_set_active'), null, ResponseAlias::HTTP_OK);
