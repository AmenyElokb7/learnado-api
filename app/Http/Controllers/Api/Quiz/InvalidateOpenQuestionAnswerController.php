...
class InvalidateOpenQuestionAnswerController extends Controller
{
    /**
    ...
    public function __invoke($answer_id) : JsonResponse
    {
        try
        {
            $answer = UserAnswersRepository::invalidateOpenQuestion($answer_id);
            return $this->returnSuccessResponse(__('answer_invalidated'), $answer, ResponseAlias::HTTP_OK);
