...
class IndexOpenAnswerController extends Controller
{
    /**
    ...
    public function __invoke(Request $request) : JsonResponse
    {
        ...
        try {
            $openAnswers = UserAnswersRepository::indexPendingOpenQuestionAnswers($paginationParams);
            return $this->returnSuccessPaginationResponse(__('open_answers_found'), $openAnswers, ResponseAlias::HTTP_OK, $paginationParams->isPaginated());
